		...
		<table class="table">
			...
			<tbody>
				...
				<tr>
					...
					<td class="col-md-2 ">
						<a href="{{url('addToCartFromWish' , $product->id)}}" class="btn-upper btn btn-primary">Add to cart</a>
					</td>
					<td class="col-md-1 close-btn">
						<a href="{{url('deleteFromWishlist' , $product->id)}}" class=""><i class="fa fa-times"></i></a>
					</td>
				</tr>
