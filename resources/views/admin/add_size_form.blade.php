    ...
    <div class="container-fluid">
      <div class="col-lg-12 mt-3">
        <div class="card-style mb-30">
          <h6 class="mb-25">Add Size</h6>

         <form action="{{url('upload_size', $id)}}" method="POST">
              @csrf
          <div class="input-style-1">
            <label>Size</label>
            <input name="size" type="text" placeholder="Size" required='require'/>
          </div>

          <button class="btn btn-outline-primary">Add size</button>
