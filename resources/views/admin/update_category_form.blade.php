    ...
    <div class="container-fluid">
      <div class="col-lg-12 mt-3">
        <div class="card-style mb-30">
          <h6 class="mb-25">Update Category</h6>

         <form action="{{url('do_update_category' , $category->id)}}" method="POST" enctype="multipart/form-data">
              @csrf
          <div class="input-style-1">
            <label>Category Name</label>
            <input name="name" type="text" placeholder="Category Name" required='require' value="{{ $category->name }}"/>
          </div>
