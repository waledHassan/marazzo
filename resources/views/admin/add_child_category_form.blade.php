    ...
    <div class="container-fluid">
      <div class="col-lg-12 mt-3">
        <div class="card-style mb-30">
          <h6 class="mb-25">Add Child Category</h6>

         <form action="{{url('upload_child_category' , $id)}}" method="POST" enctype="multipart/form-data">
              @csrf
          <div class="input-style-1">
            <label>Child Category Name</label>
            <input name="name" type="text" placeholder="Child Category Name" required='require'/>
          </div>

          <button class="btn btn-outline-primary">Add Child Category</button>
